...
//		ivIcon.setImageDrawable(view.getResources().getDrawable(getArguments().getInt(IMAGE_RESOURCE_ID)));
	...
	private void populatesFoodListView() {
		...
		foodList.setAdapter(new HottestFoodItemAdapter(getActivity(), BhojNamaSingleton.getInstance().getHottestInfoList().get(position).getHottestFoodItemList(), getArguments().getInt("position")));
	}
