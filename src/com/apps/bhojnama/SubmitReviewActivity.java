...
public class SubmitReviewActivity extends Activity implements OnClickListener {
	...
	private ErrorListener createMyReqErrorListener() {
		return new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
            	Toast.makeText(SubmitReviewActivity.this, "Server Response Error", Toast.LENGTH_SHORT).show();
            }
        };
	}
	...
	private Listener<String> createMyReqSuccessListener() {
		return new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
            	...
            	try {
					//updateCommentArray();
					Toast.makeText(SubmitReviewActivity.this, "Your review has been posted!", Toast.LENGTH_SHORT).show();
