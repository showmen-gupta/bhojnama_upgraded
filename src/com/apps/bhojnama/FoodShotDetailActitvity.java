...
public class FoodShotDetailActitvity extends Activity implements OnClickListener{
	...
	private void postComments() {
		RequestQueue queue = Volley.newRequestQueue(FoodShotDetailActitvity.this);
		StringRequest myReq = new StringRequest(Method.POST, ConstantValue.BASE_REVIEW_POST_API + BhojNamaSingleton.getInstance().getArrayListFoodShots().get(position).getFoodShotId() + "/review" , createMyReqSuccessListener(), createMyReqErrorListener()) {
	...
	private ErrorListener createMyReqErrorListener() {
		return new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
            	Toast.makeText(FoodShotDetailActitvity.this, "Server Response Error", Toast.LENGTH_SHORT).show();
            }
        };
	}
	...
	private Listener<String> createMyReqSuccessListener() {
		return new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
            	...
            	try {
					updateCommentArray();
					Toast.makeText(FoodShotDetailActitvity.this, "Your review has been posted", Toast.LENGTH_SHORT).show();
