...
public class HottestFoodItemAdapter extends BaseAdapter{
	...
	public HottestFoodItemAdapter(Context context, ArrayList<HottestFoodItemInfo> hottestInfo,int restaurantListPosition) {
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		holder.txtViewFoodName.setText(BhojNamaSingleton.getInstance().getHottestInfoList().get(listPosition).getHottestFoodItemList().get(position).getFoodTitle());
		holder.txtViewPrice.setText(BhojNamaSingleton.getInstance().getHottestInfoList().get(listPosition).getHottestFoodItemList().get(position).getPrice()+"TK");
		holder.txtViewDescription.setText(BhojNamaSingleton.getInstance().getHottestInfoList().get(listPosition).getHottestFoodItemList().get(position).getDescription());
		return convertView;
	}
